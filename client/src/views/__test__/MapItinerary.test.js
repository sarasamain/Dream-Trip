...
describe.skip('Map Itinerary', () => {
  describe('reorder', () => {
    it('it reorder items in the same day when dragged and dropped', () => {
      expect(reorder(places[1], 0, 1, ChIJtVaRHNsadkgRuD-x0eYNJ7g).toStrictEqual(getExplorePlacesReturn[0]);
